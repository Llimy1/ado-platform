 ...
 * OpenAPI schema (src/lib/api/generated/aDOPlatformAPI.schemas.ts) instead of
 * hand-duplicated. Distinct from ./projects.ts, which is the unrelated
 * Control Room dashboard mock contract.
 */
import type { AdoProjectResponse, AdoProjectCreateRequest } from "@/lib/api/generated/aDOPlatformAPI.schemas";
